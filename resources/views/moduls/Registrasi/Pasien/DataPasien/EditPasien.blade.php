...
<div class="mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
    <div>
        <h1 class="text-[22px] font-bold text-slate-900 tracking-tight">Edit Data Pasien</h1>
        <p class="text-sm text-slate-500 mt-1">Perbarui data rekam medis pasien di dalam sistem.</p>
    </div>
...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
    ...
    <!-- Form Body -->
    <div class="p-6">
        <form action="{{ route('daftar_pasien.update', $pasien->pasien_id) }}" method="POST" id="formEditPasien">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                ...
                <div>
                    ...
                    <input type="text" id="ktp" name="ktp" value="{{ old('ktp', $pasien->ktp) }}" placeholder="Masukkan 16 digit NIK" maxlength="16" inputmode="numeric"
                ...
                <div>
                    ...
                    <input type="text" id="nama_pasien" name="nama_pasien" value="{{ old('nama_pasien', $pasien->nama_pasien) }}" placeholder="Nama sesuai KTP"
                ...
                <div>
                    ...
                    <input type="text" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir', $pasien->tempat_lahir) }}" placeholder="Kota / Kabupaten"
                ...
                <div>
                    ...
                    <input type="date" id="tgl_lahir" name="tgl_lahir" value="{{ old('tgl_lahir', $pasien->tgl_lahir ? \Carbon\Carbon::parse($pasien->tgl_lahir)->format('Y-m-d') : '') }}"
                ...
                <div>
                    ...
                    <select id="jenis_kelamin" name="jenis_kelamin"
                        ...
                        {!! \App\Helpers\SelectOption::render('jenis_kelamin', old('jenis_kelamin', $pasien->jenis_kelamin)) !!}
                    </select>
                ...
                <div>
                    ...
                    <select id="agama" name="agama"
                        ...
                        {!! \App\Helpers\SelectOption::render('agama', old('agama', $pasien->agama)) !!}
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="no_hp" name="no_hp" value="{{ old('no_hp', $pasien->no_hp) }}" placeholder="Contoh: 081234567890"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="nama_ibu_kandung" name="nama_ibu_kandung" value="{{ old('nama_ibu_kandung', $pasien->nama_ibu_kandung) }}" placeholder="Nama Ibu"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="nama_ayah_kandung" name="nama_ayah_kandung" value="{{ old('nama_ayah_kandung', $pasien->nama_ayah_kandung) }}" placeholder="Nama Ayah"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                </div>
                ...
                <div>
                    ...
                    <select id="gol_darah" name="gol_darah"
                        ...
                        {!! \App\Helpers\SelectOption::render('golongan_darah', old('gol_darah', $pasien->gol_darah)) !!}
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="status_perkawinan" name="status_perkawinan"
                        ...
                        {!! \App\Helpers\SelectOption::render('status_perkawinan', old('status_perkawinan', $pasien->status_perkawinan)) !!}
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="kebangsaan" name="kebangsaan"
                        ...
                        {!! \App\Helpers\SelectOption::render('kebangsaan', old('kebangsaan', $pasien->kebangsaan)) !!}
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="suku" name="suku"
                        ...
                        {!! \App\Helpers\SelectOption::render('suku', old('suku', $pasien->suku)) !!}
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="pendidikan" name="pendidikan"
                        ...
                        {!! \App\Helpers\SelectOption::render('pendidikan', old('pendidikan', $pasien->pendidikan)) !!}
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="pekerjaan" name="pekerjaan"
                        ...
                        {!! \App\Helpers\SelectOption::render('pekerjaan', old('pekerjaan', $pasien->pekerjaan)) !!}
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="disabilitas" name="disabilitas"
                        ...
                        {!! \App\Helpers\SelectOption::render('disabilitas', old('disabilitas', $pasien->disabilitas)) !!}
                    </select>
                </div>
                ...
                <div class="md:col-span-2 mt-2">
                    ...
                    <textarea id="alamat" name="alamat" rows="3" placeholder="Jalan, RT/RW, Kelurahan, Kecamatan"
                              class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400 resize-none">{{ old('alamat', $pasien->alamat) }}</textarea>
                </div>
