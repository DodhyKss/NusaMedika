                ...
                <tr class="hover:bg-blue-50/40 transition-colors">
                    ...
                    <td class="px-3 py-3 text-center">
                        <div class="flex items-center justify-center gap-1">
                            ...
                            <form action="{{ route('daftar_pasien.destroy', $pasien->pasien_id) }}" method="POST" data-confirm-message="Yakin ingin menghapus pasien {{ $pasien->nama_pasien }}?" data-confirm-danger="true" data-confirm-title="Hapus Data">
                                @csrf
                                @method('DELETE')
