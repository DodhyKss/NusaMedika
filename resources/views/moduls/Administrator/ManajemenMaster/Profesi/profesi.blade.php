                ...
                <tr class="hover:bg-blue-50/40 transition-colors">
                    ...
                    <td class="px-3 py-3 text-center">
                        <div class="flex items-center justify-center gap-1">
                            ...
                            <form action="{{ route('admin.profesi.destroy', $profesi->profesi_id) }}" method="POST" data-confirm-message="Yakin ingin menghapus profesi {{ $profesi->nama_profesi }}?" data-confirm-danger="true" data-confirm-title="Hapus Data">
                                @csrf
                                @method('DELETE')
