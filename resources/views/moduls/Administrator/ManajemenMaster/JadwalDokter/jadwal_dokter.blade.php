                    ...
                    <tr class="hover:bg-blue-50/40 transition-colors">
                        ...
                        <td class="px-3 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <form action="{{ route('admin.jadwal_dokter.destroy', $jd->jadwal_dokter_id) }}" method="POST" data-confirm-message="Yakin ingin menghapus jadwal dokter ini?" data-confirm-danger="true" data-confirm-title="Hapus Data" class="inline">
                                    @csrf
                                    @method('DELETE')
