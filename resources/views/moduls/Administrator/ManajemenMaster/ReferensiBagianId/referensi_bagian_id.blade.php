...
<div class="mb-6 flex justify-between items-end">
    <div>
        <h1 class="text-[22px] font-bold text-slate-900 tracking-tight">Master Referensi Bagian</h1>
        ...
        <table class="w-full text-left" style="min-width: 600px;">
            <thead>
                <tr class="bg-slate-50 border-b border-slate-200">
                    ...
                    <th class="px-3 py-3 text-[11px] font-bold text-slate-500 uppercase tracking-wider">Nama Referensi</th>
                    <th class="px-3 py-3 text-[11px] font-bold text-slate-500 uppercase tracking-wider text-center">Jumlah Bagian</th>
            ...
            <tbody class="text-[12px] divide-y divide-slate-100">
                ...
                <tr class="hover:bg-blue-50/40 transition-colors">
                    ...
                    <td class="px-3 py-3 text-center">
                        <div class="flex items-center justify-center gap-1">
                            <a href="{{ route('admin.referensi_bagian_id.edit', $referensi->referensi_bagian_id) }}" class="cursor-pointer p-1.5 text-blue-500 hover:bg-blue-50 hover:text-blue-600 rounded-md transition-colors" title="Edit Referensi Bagian">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                            </a>
                            <form action="{{ route('admin.referensi_bagian_id.destroy', $referensi->referensi_bagian_id) }}" method="POST" data-confirm-message="Yakin ingin menghapus referensi bagian {{ $referensi->nama_referensi_bagian }}?" data-confirm-danger="true" data-confirm-title="Hapus Data">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-3 py-8 text-center text-slate-400">Belum ada data referensi bagian.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
