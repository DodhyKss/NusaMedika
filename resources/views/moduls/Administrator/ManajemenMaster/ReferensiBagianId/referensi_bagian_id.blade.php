                ...
                <tr class="hover:bg-blue-50/40 transition-colors">
                    ...
                    <td class="px-3 py-3 text-center">
                        <div class="flex items-center justify-center gap-1">
                            ...
                            <form action="{{ route('admin.referensi_bagian_id.destroy', $referensi->referensi_bagian_id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus referensi bagian {{ $referensi->nama_referensi_bagian }}?')">
                                @csrf
                                @method('DELETE')
