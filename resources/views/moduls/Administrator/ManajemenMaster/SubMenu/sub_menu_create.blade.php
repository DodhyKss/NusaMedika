...
<div class="mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
    <div>
        <h1 class="text-[22px] font-bold text-slate-900 tracking-tight">Tambah Sub Menu</h1>
        <p class="text-sm text-slate-500 mt-1">Buat sub menu baru di dalam menu.</p>
    </div>
...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
    <div class="p-6">
        <form action="{{ route('admin.sub_menu.store') }}" method="POST" id="formTambahSubMenu">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                ...
                <div>
                    ...
                    <input type="text" id="nama_sub_menu" name="nama_sub_menu" value="{{ old('nama_sub_menu') }}" placeholder="Contoh: Laporan Keuangan"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                ...
                <div>
                    ...
                    <input type="text" id="file_sub_menu" name="file_sub_menu" value="{{ old('file_sub_menu') }}" placeholder="Contoh: Administrator/ManajemenMaster/Modul/modul atau #"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
