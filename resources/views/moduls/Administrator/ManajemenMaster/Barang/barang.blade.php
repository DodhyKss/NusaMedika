...
<div class="mb-6 flex justify-between items-end">
    <div>
        ...
        <p class="text-sm text-slate-500 mt-1">Kelola data barang / obat yang tersedia di fasilitas.</p>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
            ...
            <div class="col-span-1 md:col-span-3">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="search" name="search" value="{{ old('search', $search) }}" placeholder="Cari Nama Barang / Jenis Barang..."
        ...
        <table class="w-full text-left" style="min-width: 600px;">
            <thead>
                <tr class="bg-slate-50 border-b border-slate-200">
                    ...
                    <th class="px-3 py-3 text-[11px] font-bold text-slate-500 uppercase tracking-wider">Jenis Barang</th>
