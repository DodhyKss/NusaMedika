                ...
                <tr class="hover:bg-blue-50/40 transition-colors">
                    ...
                    <td class="px-3 py-3 text-center">
                        <div class="flex items-center justify-center gap-1">
                            ...
                            <form action="{{ route('admin.bagian.destroy', $bagian->bagian_id) }}" method="POST" data-confirm-message="Yakin ingin menghapus bagian {{ $bagian->nama_bagian }}?" data-confirm-danger="true" data-confirm-title="Hapus Data">
                                @csrf
                                @method('DELETE')
