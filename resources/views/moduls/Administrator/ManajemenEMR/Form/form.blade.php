                ...
                <tr class="hover:bg-blue-50/40 transition-colors">
                    ...
                    <td class="px-3 py-3 text-center">
                        <div class="flex items-center justify-center gap-1">
                            ...
                            <form action="{{ route('admin.form.destroy', ['form' => $row->$pk, 'tab' => $tab]) }}" method="POST" data-confirm-message="Yakin ingin menghapus {{ $tab }} ini beserta relasinya?" data-confirm-danger="true" data-confirm-title="Hapus Data">
                                @csrf
                                @method('DELETE')
