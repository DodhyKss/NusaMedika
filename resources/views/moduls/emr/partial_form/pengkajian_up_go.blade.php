<x-emr-accordion id="acc-pengkajian-up-go" title="F. Pengkajian Up & Go" bgClass="bg-yellow-50" :isOpen="true">
            ...
            <table class="w-full text-[13px] text-left border-collapse text-slate-700">
                ...
                <tbody>
                        ...
                        <td class="border border-slate-300 p-3">
                            ...
                            <div class="space-y-2">
                                <label class="flex items-start gap-2 cursor-pointer">
                                    ...
                                    <input type="checkbox" name="up_go_1_a" class="mt-1 rounded-sm text-blue-500 focus:ring-blue-500 w-4 h-4">
                                    <span>Tidak seimbang / sempoyongan / pincang</span>
                                </label>
                                <label class="flex items-start gap-2 cursor-pointer">
                                    <span class="font-medium mr-1">b.</span>
                                    <input type="checkbox" name="up_go_1_b" class="mt-1 rounded-sm text-blue-500 focus:ring-blue-500 w-4 h-4">
                    ...
                    <tr>
                        ...
                        <td class="border border-slate-300 p-3">
                            <label class="flex items-start gap-2 cursor-pointer">
                                <input type="checkbox" name="up_go_2" class="mt-1 rounded-sm text-blue-500 focus:ring-blue-500 w-4 h-4">
