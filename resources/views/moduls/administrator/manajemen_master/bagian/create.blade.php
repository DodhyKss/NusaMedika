...
<div class="mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
    <div>
        <h1 class="text-[22px] font-bold text-slate-900 tracking-tight">Tambah Bagian</h1>
        <p class="text-sm text-slate-500 mt-1">Buat bagian / unit kerja baru.</p>
    </div>
...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
    <div class="p-6">
        <form action="{{ route('admin.bagian.store') }}" method="POST" id="formTambahBagian">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                ...
                <div>
                    ...
                    <input type="number" id="referensi_bagian" name="referensi_bagian" value="{{ old('referensi_bagian') }}" placeholder="Contoh: 1"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                ...
                <div>
                    ...
                    <input type="text" id="group_bagian" name="group_bagian" value="{{ old('group_bagian') }}" placeholder="Contoh: RJ"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                ...
                <div>
                    ...
                    <input type="text" id="seri_bagian" name="seri_bagian" value="{{ old('seri_bagian') }}"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                ...
                <div>
                    ...
                    <input type="number" id="id_location" name="id_location" value="{{ old('id_location') }}"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                ...
                <div class="md:col-span-2">
                    <label class="flex items-center gap-2.5 cursor-pointer">
                        <input type="checkbox" name="flag_eksekutif" value="1" {{ old('flag_eksekutif') ? 'checked' : '' }}
