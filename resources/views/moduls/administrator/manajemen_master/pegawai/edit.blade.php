...
<div class="mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
    <div>
        <h1 class="text-[22px] font-bold text-slate-900 tracking-tight">Edit Pegawai</h1>
        <p class="text-sm text-slate-500 mt-1">Perbarui data pegawai.</p>
    </div>
...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
    <div class="p-6">
        <form action="{{ route('admin.pegawai.update', $pegawai->pegawai_id) }}" method="POST" id="formEditPegawai">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="nama_pegawai" name="nama_pegawai" value="{{ old('nama_pegawai', $pegawai->nama_pegawai) }}"
                ...
                <div>
                    ...
                    <select id="bagian_id" name="bagian_id" class="select2 w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 appearance-none" style="width: 100%">
                        ...
                        @foreach ($bagians as $bagian)
                            <option value="{{ $bagian->bagian_id }}" {{ old('bagian_id', $pegawai->bagian_id) == $bagian->bagian_id ? 'selected' : '' }}>{{ $bagian->nama_bagian }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select id="profesi_id" name="profesi_id"
                        ...
                        @foreach ($profesis as $profesi)
                            <option value="{{ $profesi->profesi_id }}" {{ old('profesi_id', $pegawai->profesi_id) == $profesi->profesi_id ? 'selected' : '' }}>{{ $profesi->nama_profesi }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select id="jabatan_id" name="jabatan_id"
                        ...
                        @foreach ($jabatans as $jabatan)
                            <option value="{{ $jabatan->jabatan_id }}" {{ old('jabatan_id', $pegawai->jabatan_id) == $jabatan->jabatan_id ? 'selected' : '' }}>{{ $jabatan->nama_jabatan }}</option>
                        @endforeach
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                <div>
                    ...
                    <input type="text" id="sip" name="sip" value="{{ old('sip', $pegawai->sip) }}"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                ...
                <div>
                    ...
                    <input type="date" id="tgl_awal_sip" name="tgl_awal_sip" value="{{ old('tgl_awal_sip', $pegawai->tgl_awal_sip) }}"
                ...
                <div>
                    ...
                    <input type="date" id="tgl_akhir_sip" name="tgl_akhir_sip" value="{{ old('tgl_akhir_sip', $pegawai->tgl_akhir_sip) }}"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700">
                ...
                <div>
                    ...
                    <input type="text" id="str" name="str" value="{{ old('str', $pegawai->str) }}"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                ...
                <div>
                    ...
                    <input type="date" id="tgl_awal_str" name="tgl_awal_str" value="{{ old('tgl_awal_str', $pegawai->tgl_awal_str) }}"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700">
                ...
                <div>
                    ...
                    <input type="date" id="tgl_akhir_str" name="tgl_akhir_str" value="{{ old('tgl_akhir_str', $pegawai->tgl_akhir_str) }}"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700">
                ...
                <div>
                    ...
                    <input type="text" id="no_rfid" name="no_rfid" value="{{ old('no_rfid', $pegawai->no_rfid) }}"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
                ...
                <div>
                    ...
                    <input type="text" id="id_satu_sehat" name="id_satu_sehat" value="{{ old('id_satu_sehat', $pegawai->id_satu_sehat) }}"
                           class="w-full text-sm border border-slate-200 rounded-lg px-3.5 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-slate-700 placeholder-slate-400">
