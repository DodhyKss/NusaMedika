        ...
        <div class="overflow-x-auto drag-scroll">
            <table class="w-full text-left" style="min-width: 640px;">
                ...
                <tbody class="text-[12px] divide-y divide-slate-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-5 py-6 text-center text-xs text-slate-400">Tidak ada item.</td>
                        </tr>
                    @endforelse
                </tbody>
                <tfoot class="border-t border-slate-200 bg-slate-50/60">
                    <tr>
                        <td colspan="7" class="px-5 py-2.5 text-right text-xs font-bold text-slate-600 uppercase tracking-wider">Total Nilai</td>
