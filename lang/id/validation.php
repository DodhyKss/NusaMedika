...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut berisi pesan error bawaan yang dipakai oleh
    | validator. Beberapa aturan memiliki beberapa versi seperti aturan
    | size. Silakan sesuaikan setiap pesan di sini.
    |
    */
    ...
    'encoding' => 'Kolom :attribute harus di-encode dalam :encoding.',
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute yang diberikan telah muncul di kebocoran data. Pilihlah :attribute yang berbeda.',
    ],
    ...
    */
    ...
    | dengan sesuatu yang lebih ramah dibaca seperti "No. KTP / NIK"
    | menggantikan "ktp".
    |
    */
    ...
    'attributes' => [
        ...
        'wilayah_provinsi_id' => 'Provinsi',
        'wilayah_kabupaten_id' => 'Kabupaten/Kota',
