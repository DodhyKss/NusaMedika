...
class ReferensiBagianSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ID menyesuaikan nilai referensi_bagian_id di FormObjekSeeder / env:
        ...
        $referensiBagians = [
            ...
            ['referensi_bagian_id' => 5, 'nama_referensi_bagian' => 'DEPO'],
            ['referensi_bagian_id' => 6, 'nama_referensi_bagian' => 'PENUNJANG MEDIS'],
        ];
