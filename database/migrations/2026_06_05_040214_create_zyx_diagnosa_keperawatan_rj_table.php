...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_diagnosa_keperawatan_rj', function (Blueprint $table) {
            $table->increments('zyx_diagnosa_keperawatan_rj_id');
    ...
    {
        Schema::dropIfExists('zyx_diagnosa_keperawatan_rj');
    }
};
