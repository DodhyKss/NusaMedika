...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_index_remunerasi', function (Blueprint $table) {
            $table->increments('zyx_index_remunerasi_id');
            $table->integer('index_remunerasi_id');
    ...
    {
        Schema::dropIfExists('zyx_index_remunerasi');
    }
};
