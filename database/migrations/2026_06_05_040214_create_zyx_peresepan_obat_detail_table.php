...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_peresepan_obat_detail', function (Blueprint $table) {
            $table->increments('zyx_peresepan_obat_detail_id');
    ...
    {
        Schema::dropIfExists('zyx_peresepan_obat_detail');
    }
};
