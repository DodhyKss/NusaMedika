...
return new class extends Migration
{
    ...
    {
        Schema::create('diagnosa_keperawatan_intervensi', function (Blueprint $table) {
            $table->integer('diagnosa_keperawatan_intervensi_id')->primary();
    ...
    {
        Schema::dropIfExists('diagnosa_keperawatan_intervensi');
    }
};
