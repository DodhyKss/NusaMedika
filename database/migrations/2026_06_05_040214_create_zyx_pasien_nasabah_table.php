...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_pasien_nasabah', function (Blueprint $table) {
            $table->increments('zyx_pasien_nasabah_id');
            $table->integer('pasien_nasabah_id');
    ...
    {
        Schema::dropIfExists('zyx_pasien_nasabah');
    }
};
