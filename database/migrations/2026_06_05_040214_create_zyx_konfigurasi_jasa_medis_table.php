...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_konfigurasi_jasa_medis', function (Blueprint $table) {
            $table->increments('zyx_konfigurasi_jasa_medis_id');
            $table->integer('konfigurasi_jasa_medis_id');
    ...
    {
        Schema::dropIfExists('zyx_konfigurasi_jasa_medis');
    }
};
