...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_draft_material_request_detail', function (Blueprint $table) {
            $table->increments('zyx_draft_material_request_detail_id');
            $table->integer('draft_material_request_detail_id');
...
3 = Fopi');
    ...
    {
        Schema::dropIfExists('zyx_draft_material_request_detail');
    }
};
