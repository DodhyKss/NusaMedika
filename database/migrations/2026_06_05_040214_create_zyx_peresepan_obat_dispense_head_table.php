...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_peresepan_obat_dispense_head', function (Blueprint $table) {
            $table->increments('zyx_peresepan_obat_dispense_head_id');
    ...
    {
        Schema::dropIfExists('zyx_peresepan_obat_dispense_head');
    }
};
