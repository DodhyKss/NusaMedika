...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_capture_bor', function (Blueprint $table) {
            $table->increments('zyx_capture_bor_id');
            $table->integer('capture_bor_id');
    ...
    {
        Schema::dropIfExists('zyx_capture_bor');
    }
};
