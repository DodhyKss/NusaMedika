...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_penerimaan_brg_detail', function (Blueprint $table) {
            $table->increments('zyx_penerimaan_brg_detail_id');
    ...
    {
        Schema::dropIfExists('zyx_penerimaan_brg_detail');
    }
};
