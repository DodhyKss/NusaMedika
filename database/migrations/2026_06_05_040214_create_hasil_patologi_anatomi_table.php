...
return new class extends Migration
{
    ...
    {
        Schema::create('hasil_patologi_anatomi', function (Blueprint $table) {
            $table->integer('hasil_patologi_anatomi_id')->primary();
    ...
    {
        Schema::dropIfExists('hasil_patologi_anatomi');
    }
};
