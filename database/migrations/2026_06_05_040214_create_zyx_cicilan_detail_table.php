...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_cicilan_detail', function (Blueprint $table) {
            $table->increments('zyx_cicilan_detail_id');
            $table->integer('cicilan_detail_id');
    ...
    {
        Schema::dropIfExists('zyx_cicilan_detail');
    }
};
