...
return new class extends Migration
{
    ...
    {
        Schema::create('diagnosa_keperawatan_indikasi_kriteria', function (Blueprint $table) {
            $table->integer('diagnosa_keperawatan_indikasi_kriteria_id')->primary();
    ...
    {
        Schema::dropIfExists('diagnosa_keperawatan_indikasi_kriteria');
    }
};
