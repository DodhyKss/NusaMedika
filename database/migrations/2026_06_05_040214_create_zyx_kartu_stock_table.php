...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_kartu_stock', function (Blueprint $table) {
            $table->increments('zyx_kartu_stock_id');
            $table->integer('kartu_stock_id');
    ...
    {
        Schema::dropIfExists('zyx_kartu_stock');
    }
};
