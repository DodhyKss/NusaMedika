...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_pesan_bedah', function (Blueprint $table) {
            $table->increments('zyx_pesan_bedah_id');
            $table->integer('pesan_bedah_id');
    ...
    {
        Schema::dropIfExists('zyx_pesan_bedah');
    }
};
