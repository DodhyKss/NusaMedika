...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE VIEW \"master_tarif\" AS SELECT sum(master_tarif.biaya) AS tarif_tindakan,
    master_tarif.nama_tindakan,
    master_tarif.nama_kelas_ruang,
    master_tarif.tindakan_id,
    master_tarif.bagian_id,
    master_tarif.kelas_ruang_id
  ...
  GROUP BY master_tarif.tindakan_id, master_tarif.nama_tindakan, master_tarif.nama_kelas_ruang, master_tarif.bagian_id, master_tarif.kelas_ruang_id;");
    }
