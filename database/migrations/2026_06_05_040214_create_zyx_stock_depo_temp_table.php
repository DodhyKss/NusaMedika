...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_stock_depo_temp', function (Blueprint $table) {
            $table->increments('zyx_stock_depo_temp_id');
            $table->integer('stock_depo_temp_id');
    ...
    {
        Schema::dropIfExists('zyx_stock_depo_temp');
    }
};
