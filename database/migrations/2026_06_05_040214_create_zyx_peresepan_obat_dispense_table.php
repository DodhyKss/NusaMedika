...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_peresepan_obat_dispense', function (Blueprint $table) {
            $table->increments('zyx_peresepan_obat_dispense_id');
            $table->integer('peresepan_obat_dispense_id');
...
7 = racikan');
    ...
    {
        Schema::dropIfExists('zyx_peresepan_obat_dispense');
    }
};
