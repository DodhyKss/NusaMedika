...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_riwayat_kll', function (Blueprint $table) {
            $table->increments('zyx_riwayat_kll_id');
            $table->integer('riwayat_kll_id');
    ...
    {
        Schema::dropIfExists('zyx_riwayat_kll');
    }
};
