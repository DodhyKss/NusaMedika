...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_hasil_rad_foto', function (Blueprint $table) {
            $table->increments('zyx_hasil_rad_foto_id');
            $table->integer('hasil_rad_foto_id');
    ...
    {
        Schema::dropIfExists('zyx_hasil_rad_foto');
    }
};
