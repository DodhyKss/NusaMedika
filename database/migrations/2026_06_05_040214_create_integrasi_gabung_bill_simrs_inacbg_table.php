...
return new class extends Migration
{
    ...
    {
        Schema::create('integrasi_gabung_bill_simrs_inacbg', function (Blueprint $table) {
            $table->integer('integrasi_gabung_bill_id')->primary();
    ...
    {
        Schema::dropIfExists('integrasi_gabung_bill_simrs_inacbg');
    }
};
