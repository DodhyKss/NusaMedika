...
return new class extends Migration
{
    ...
    {
        Schema::create('konfigurasi_satu_sehat', function (Blueprint $table) {
            $table->integer('konfigurasi_satu_sehat_id')->primary();
    ...
    {
        Schema::dropIfExists('konfigurasi_satu_sehat');
    }
};
