...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_peresepan_obat', function (Blueprint $table) {
            $table->increments('zyx_peresepan_obat_id');
...
4 = resep dibatalkan');
            ...
            $table->integer('flagging_resep')->nullable();
    ...
    {
        Schema::dropIfExists('zyx_peresepan_obat');
    }
};
