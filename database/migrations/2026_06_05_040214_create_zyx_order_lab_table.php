...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_order_lab', function (Blueprint $table) {
            $table->increments('zyx_order_lab_id');
            $table->integer('order_lab_id');
            ...
            $table->smallInteger('flag_manual')->nullable()->comment('1 = order dokter
2 = setelah hasil oleh perawat');
    ...
    {
        Schema::dropIfExists('zyx_order_lab');
    }
};
