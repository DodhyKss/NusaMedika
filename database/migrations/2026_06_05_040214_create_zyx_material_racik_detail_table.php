...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_material_racik_detail', function (Blueprint $table) {
            $table->increments('zyx_material_racik_detail_id');
            $table->integer('material_racik_detail_id');
    ...
    {
        Schema::dropIfExists('zyx_material_racik_detail');
    }
};
