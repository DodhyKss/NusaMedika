...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_pemesanan_brg_detail', function (Blueprint $table) {
            $table->increments('zyx_pemesanan_brg_detail_id');
    ...
    {
        Schema::dropIfExists('zyx_pemesanan_brg_detail');
    }
};
