...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_rujukan_pasien', function (Blueprint $table) {
            $table->increments('zyx_rujukan_pasien_id');
            $table->integer('rujukan_pasien_id');
    ...
    {
        Schema::dropIfExists('zyx_rujukan_pasien');
    }
};
