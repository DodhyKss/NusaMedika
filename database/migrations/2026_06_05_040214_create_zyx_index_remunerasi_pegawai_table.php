...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_index_remunerasi_pegawai', function (Blueprint $table) {
            $table->increments('zyx_index_remunerasi_pegawai_id');
...
- mengikuti_senam');
    ...
    {
        Schema::dropIfExists('zyx_index_remunerasi_pegawai');
    }
};
