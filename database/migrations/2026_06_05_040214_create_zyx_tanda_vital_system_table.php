...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_tanda_vital_system', function (Blueprint $table) {
            $table->increments('zyx_tanda_vital_system_id');
            $table->integer('tanda_vital_system_id');
    ...
    {
        Schema::dropIfExists('zyx_tanda_vital_system');
    }
};
