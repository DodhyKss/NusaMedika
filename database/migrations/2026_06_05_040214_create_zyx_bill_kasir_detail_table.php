...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_bill_kasir_detail', function (Blueprint $table) {
            $table->increments('zyx_bill_kasir_detail_id');
            ...
            $table->decimal('biaya_hak', 18)->nullable();
            $table->decimal('diskon', 18)->nullable();
            $table->decimal('diskon_hak', 18)->nullable();
            $table->decimal('total', 18)->nullable();
            $table->decimal('total_hak', 18)->nullable();
            ...
            $table->decimal('biaya_2', 18)->nullable();
            $table->decimal('biaya_hak_2', 18)->nullable();
            $table->decimal('diskon_2', 18)->nullable();
            $table->decimal('diskon_hak_2', 18)->nullable();
            $table->decimal('total_2', 18)->nullable();
            $table->decimal('total_hak_2', 18)->nullable();
            $table->decimal('biaya_3', 18)->nullable();
            $table->decimal('biaya_hak_3', 18)->nullable();
            $table->decimal('diskon_3', 18)->nullable();
            $table->decimal('diskon_hak_3', 18)->nullable();
            $table->decimal('total_3', 18)->nullable();
            $table->decimal('total_hak_3', 18)->nullable();
            $table->decimal('biaya_administrasi', 18)->nullable();
            $table->decimal('biaya_administrasi_2', 18)->nullable();
            $table->decimal('biaya_administrasi_3', 18)->nullable();
    ...
    {
        Schema::dropIfExists('zyx_bill_kasir_detail');
    }
};
