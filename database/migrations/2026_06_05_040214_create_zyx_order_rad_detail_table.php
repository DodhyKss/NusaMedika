...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_order_rad_detail', function (Blueprint $table) {
            $table->increments('zyx_order_rad_detail_id');
            $table->integer('order_rad_detail_id');
    ...
    {
        Schema::dropIfExists('zyx_order_rad_detail');
    }
};
