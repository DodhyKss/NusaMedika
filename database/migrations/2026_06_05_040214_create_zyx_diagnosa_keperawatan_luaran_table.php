...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_diagnosa_keperawatan_luaran', function (Blueprint $table) {
            $table->increments('zyx_diagnosa_keperawatan_luaran_id');
            $table->integer('diagnosa_keperawatan_luaran_id');
    ...
    {
        Schema::dropIfExists('zyx_diagnosa_keperawatan_luaran');
    }
};
