...
return new class extends Migration
{
    ...
    {
        Schema::create('material_request_approval', function (Blueprint $table) {
            $table->integer('material_request_approval_id')->primary();
...
1 = approval MR cito');
    ...
    {
        Schema::dropIfExists('material_request_approval');
    }
};
