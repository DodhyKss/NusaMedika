...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE VIEW \"erwin_view2\" AS SELECT z.tindakan_id,
    z.nama_tindakan,
    z.tindakan_detail_id,
    z.nama_tindakan_detail,
    z.tarif_id,
    z.flag,
        CASE
            WHEN (z.flag = 'child'::text) THEN ( SELECT tindakan.tindakan_id
               FROM tindakan
        ...
        CASE
            WHEN (z.flag = 'child'::text) THEN ( SELECT tarif.tarif_id
               FROM ((tarif
   ...
   FROM ( SELECT a.tindakan_id,
           ...
           FROM ((tindakan a
             ...
             LEFT JOIN tarif c ON ((c.tindakan_detail_id = b.tindakan_detail_id)))) z;");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS \"erwin_view2\"");
    }
};
