...
return new class extends Migration
{
    ...
    {
        Schema::create('material_request_detail_partisi', function (Blueprint $table) {
            $table->integer('material_request_detail_partisi_id')->primary();
    ...
    {
        Schema::dropIfExists('material_request_detail_partisi');
    }
};
