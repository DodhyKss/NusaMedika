...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE VIEW \"view_bill_group_detail\" AS SELECT level_one.kategori_inacbg,
    level_one.bill_temp_id,
    level_one.input_time,
    level_one.input_user_id,
    level_one.nama_bagian,
    level_one.jenis_tindakan,
    level_one.tindakan_id,
    level_one.jenis_tindakan_id,
    level_one.nama_tindakan,
    level_one.barang_golongan_detail_id,
    level_one.jumlah,
    level_one.tgl_tindakan,
    level_one.nama_tindakan_detail,
    level_one.nama_pegawai,
    level_one.biaya
  ...
  ORDER BY
        CASE
            WHEN (level_one.tgl_tindakan IS NULL) THEN level_one.input_time
            ELSE level_one.tgl_tindakan
        END;");
    }
