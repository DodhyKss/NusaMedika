...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_konfigurasi_pembagi_jasmed_3', function (Blueprint $table) {
            $table->increments('zyx_konfigurasi_pembagi_jasmed_3_id');
    ...
    {
        Schema::dropIfExists('zyx_konfigurasi_pembagi_jasmed_3');
    }
};
