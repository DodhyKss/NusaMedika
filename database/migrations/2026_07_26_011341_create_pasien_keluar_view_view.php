...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE OR REPLACE VIEW \"pasien_keluar_view\" AS SELECT table_two.pasien_id,
   ...
   FROM ((((((( SELECT table_one.pasien_id,
            ...
            ( SELECT bed_log_1.bed_id
                  ...
                  WHERE ((bed_log_1.registrasi_detail_id = table_one.registrasi_detail_id) AND (bed_log_1.status_bed_log = 5))
                  ORDER BY bed_log_1.bed_log_id DESC
           ...
           FROM ( SELECT registrasi.pasien_id,
                    ...
                    ( SELECT registrasi_detail.registrasi_detail_id
                          ...
                          ORDER BY registrasi_detail.registrasi_detail_id DESC
  ...
  ORDER BY kelas_ruang.nama_kelas_ruang;");
    ...
    {
        DB::statement("DROP VIEW IF EXISTS \"pasien_keluar_view\"");
    }
};
