...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_supplier_barang', function (Blueprint $table) {
            $table->increments('zyx_supplier_barang_id');
            $table->integer('supplier_barang_id');
    ...
    {
        Schema::dropIfExists('zyx_supplier_barang');
    }
};
