...
return new class extends Migration
{
    ...
    {
        Schema::create('selisih_kelas_vip', function (Blueprint $table) {
            $table->integer('selisih_kelas_vip_id')->primary();
            ...
            $table->smallInteger('jenis_hak_kelas')->nullable();
    ...
    {
        Schema::dropIfExists('selisih_kelas_vip');
    }
};
