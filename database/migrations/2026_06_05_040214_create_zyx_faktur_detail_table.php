...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_faktur_detail', function (Blueprint $table) {
            $table->increments('zyx_faktur_detail_id');
            $table->integer('faktur_detail_id');
    ...
    {
        Schema::dropIfExists('zyx_faktur_detail');
    }
};
