...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_registrasi_detail', function (Blueprint $table) {
            $table->increments('zyx_registrasi_detail_id');
            ...
            $table->integer('asal_daftar')->nullable();
    ...
    {
        Schema::dropIfExists('zyx_registrasi_detail');
    }
};
