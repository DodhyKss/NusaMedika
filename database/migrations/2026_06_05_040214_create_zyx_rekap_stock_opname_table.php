...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_rekap_stock_opname', function (Blueprint $table) {
            $table->increments('zyx_rekap_stock_opname_id');
            ...
            $table->decimal('jumlah_stock_opname', 18)->nullable();
            ...
            $table->decimal('jumlah_stock_kartu_stock', 18)->nullable();
    ...
    {
        Schema::dropIfExists('zyx_rekap_stock_opname');
    }
};
