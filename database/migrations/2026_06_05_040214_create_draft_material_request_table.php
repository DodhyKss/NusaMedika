...
return new class extends Migration
{
    ...
    {
        Schema::create('draft_material_request', function (Blueprint $table) {
            $table->integer('draft_material_request_id')->primary();
...
3 = Fopi');
    ...
    {
        Schema::dropIfExists('draft_material_request');
    }
};
