...
return new class extends Migration
{
    ...
    {
        Schema::create('zyx_peresepan_obat_retur', function (Blueprint $table) {
            $table->increments('zyx_peresepan_obat_retur_id');
    ...
    {
        Schema::dropIfExists('zyx_peresepan_obat_retur');
    }
};
