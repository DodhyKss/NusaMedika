...
class WilayahController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('moduls.Administrator.ManajemenMaster.Wilayah.wilayah', compact('tab', 'data', 'provinsis', 'kabupatens', 'kecamatans'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('moduls.Administrator.ManajemenMaster.Wilayah.wilayah_form', $this->formData($tab));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('moduls.Administrator.ManajemenMaster.Wilayah.wilayah_form', array_merge(['wilayah' => $wilayah], $this->formData($tab)));
    }
