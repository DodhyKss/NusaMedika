...
class JadwalDokterController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('moduls.Administrator.ManajemenMaster.JadwalDokter.jadwal_dokter', compact('jadwals', 'search', 'hariMap'));
    }

    public function create()
    {
        return view('moduls.Administrator.ManajemenMaster.JadwalDokter.jadwal_dokter_create', ['hariMap' => self::HARI]);
    }
    ...
    public function edit($jadwal)
    {
        ...
        return view('moduls.Administrator.ManajemenMaster.JadwalDokter.jadwal_dokter_edit', ['jadwal' => $jadwal, 'hariMap' => self::HARI]);
    }
